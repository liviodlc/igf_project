...
public class Main {
	...
	public void setWindow(){
		...
		window.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE); //exit the program when the window closes
	...
	public void setRooms(){
		...
		roomView.setSize(window.getWidth(), 715);
	...
	/**
	 * JSlider has a jump to tick function, but since
	 * the spacing is actually 35 ticks, the function will likely
	 * jump to unmarked ticks and not major ticks.
	 * This class makes the jumping to major ticks (absolute spectrum
	 * places, like visible/infared/etc) but allows the user to drag the
